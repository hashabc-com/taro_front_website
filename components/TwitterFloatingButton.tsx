...
export default function TwitterFloatingButton() {
  ...
  const handleTelegramClick = () => {
    ...
    window.open('https://t.me/Young168l', '_blank', 'noopener,noreferrer');
  };
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-1 -right-1 w-2 h-2 bg-blue-300 rounded-full animate-bounce opacity-60" style={{ animationDelay: '0s' }}></div>
        <div className="absolute -bottom-1 -left-1 w-1.5 h-1.5 bg-blue-400 rounded-full animate-bounce opacity-50" style={{ animationDelay: '0.5s' }}></div>
