      ...
      <div className="mx-auto max-w-7xl pt-32 pb-24 sm:pt-40 sm:pb-32">
        ...
        >
          {[
            ...
            >
              <div className="text-3xl font-bold text-white group-hover:text-blue-400 transition-colors duration-200 ease-out">
                {stat.title}
              </div>
              <div className="text-sm text-gray-400 mt-1 group-hover:text-gray-300 transition-colors duration-200 ease-out">
                {stat.subtitle}
              </div>
            </div>
          ))}
