  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Hero Section */}
        <div id="services" ref={heroRef} className="opacity-0 translate-y-5 transition-all duration-500 ease-out mx-auto max-w-4xl text-center mb-20 scroll-mt-24">
        ...
        <div id="advantages" className="mb-20 scroll-mt-24">
          ...
          <div ref={advantagesRef} className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {advantages.map((advantage, index) => (
              ...
              >
                ...
                <div className={`relative inline-flex p-3 rounded-lg bg-gradient-to-r ${advantage.gradient} shadow-lg group-hover:shadow-xl transition-shadow duration-300 mb-4`}>
          ...
          <div ref={goalsRef} className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            {goals.map((goal, index) => (
              ...
              >
                ...
                <div className={`relative inline-flex p-4 rounded-lg bg-gradient-to-r ${goal.gradient} shadow-lg group-hover:shadow-xl transition-shadow duration-300 mb-6`}>
        ...
        {/* Contact Section */}
        <div ref={contactRef} className="opacity-0 translate-y-5 transition-all duration-500 ease-out">
          <div className="mx-auto max-w-4xl text-center rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-12 backdrop-blur-sm border border-gray-700/50">
            ...
            <div className="inline-flex items-center gap-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer">
              <span className="text-lg font-semibold">{t('contact.form.submit')}</span>
